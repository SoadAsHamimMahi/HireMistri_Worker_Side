...
const code = fs.readFileSync('src/routes/EditProfile.jsx', 'utf-8');

const [top_part, bottom_part] = code.split('  if (loading) {');

const new_render = `  if (loading) {
    return (
...
fs.writeFileSync('src/routes/EditProfile.jsx', top_part + new_render, 'utf-8');
